...
#define MODULE_VERSION_NEW_SHELL         "new_shell"        " V1.0.0.0"     " "     TRUNK_TIME "("BUILD_NUM")"
...
#define MODULE_VERSION_ACCESSLIMITCMD    "accesslimitcmd"" V1.2.0.0"     " "     TRUNK_TIME "("BUILD_NUM")"
