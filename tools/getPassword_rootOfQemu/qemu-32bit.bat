@ECHO OFF
CLS
if not exist "C:\Program Files(x86)\qemu\qemu-system-arm.exe" goto no.QEMU
...
ECHO File C:\Program Files(x86)\qemu\qemu-system-arm.exe non presente.
ECHO.
ECHO Verifica di aver installato QEMU a 32bit.
ECHO.
ECHO.
