...
# Jake, 2018-11-15, remove dependency with TCSUPPORT_RELEASED_CODE to resolve TCP connection fail if request is from non-default WAN.
...
ifneq ($(strip $(ZYXEL_SW_INTERNET_LED_BLINK)),)
export ZYXEL_SW_INTERNET_LED_BLINK
TC_CFLAGS+=-DZYXEL_SW_INTERNET_LED_BLINK
endif

ifneq ($(strip $(ZYXEL_PLATFORM_VMG1302_T20A_BRAZIL)),)
export ZYXEL_PLATFORM_VMG1302_T20A_BRAZIL
TC_CFLAGS+=-DZYXEL_PLATFORM_VMG1302_T20A_BRAZIL
endif

ifneq ($(strip $(ZYXEL_WLAN_WPS_CO_BTN)),)
export ZYXEL_WLAN_WPS_CO_BTN
TC_CFLAGS+=-DZYXEL_WLAN_WPS_CO_BTN
endif
...
ifneq ($(strip $(ZYXEL_VMG1312T20B_FIX_CRC_ERROR)),)
export ZYXEL_VMG1312T20B_FIX_CRC_ERROR
TC_CFLAGS+=-DZYXEL_VMG1312T20B_FIX_CRC_ERROR
endif
